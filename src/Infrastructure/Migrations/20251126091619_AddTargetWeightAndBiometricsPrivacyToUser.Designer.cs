...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251126091619_AddTargetWeightAndBiometricsPrivacyToUser")]
    partial class AddTargetWeightAndBiometricsPrivacyToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BodyMeasurement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("body_measurements", null, t =>
                        {
                            t.HasCheckConstraint("CK_body_measurements_bmi_valid", "\"BMI\" >= 10 AND \"BMI\" <= 100");

                            t.HasCheckConstraint("CK_body_measurements_height_valid", "\"HeightCm\" >= 50 AND \"HeightCm\" <= 300");

                            t.HasCheckConstraint("CK_body_measurements_weight_positive", "\"WeightKg\" > 0 AND \"WeightKg\" < 500");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("ShareBiometricsWithFriends")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.WorkoutSession", b =>
                {
                    ...
                    b.Property<bool>("IsQuickComplete")
                        .HasColumnType("boolean");
